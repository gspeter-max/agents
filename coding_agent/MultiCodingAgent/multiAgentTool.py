...
def runCommondInTerminal(Commond: typing.Union[str, typing.List]) -> str:
    ...
    :param Commond: A single command as a string or a list of commands to be executed in sequence.
    :type Commond: typing.Union[str, typing.List]
